import {Decorators, Metadata} from './meta/index';
...
export function registration(value : any, targetKey?:string){
  return function(target){
    Metadata.define((<any>Metadata).registration, value, target, targetKey);
  }
}
...
export function instanceActivator(value : any, targetKey?:string){
  return function(target){
    Metadata.define((<any>Metadata).instanceActivator, value, target, targetKey);
  }
}
